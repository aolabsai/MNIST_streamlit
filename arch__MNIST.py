...
arch_i_bw = [14 * 14]
arch_i_gr = [8 for i in range(392)]
...
connector_parameters_bw = [190, 190, 190, 4]
connector_parameters_grey = [1600, 400, 1600, 4]
arch_bw = ar.Arch(
    arch_i_bw, arch_z, arch_c, connector_function, connector_parameters_bw, description
)
arch_gr = ar.Arch(
    arch_i_gr, arch_z, arch_c, connector_function, connector_parameters_grey, description
)
